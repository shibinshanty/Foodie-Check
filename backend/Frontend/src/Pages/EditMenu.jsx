...
const EditMenu = () => {
  ...
  const loadMenus = async () => {
    ...
    try {
      const { data } = await axios.get("https://foodie-check.onrender.com/menus/all", {
  ...
  const handleCreateMenu = async (e) => {
    ...
    try {
      const { data } = await axios.post("https://foodie-check.onrender.com/menus/create", newMenu, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleAddItem = async (e) => {
    ...
    try {
      const response = await axios.post(
        `https://foodie-check.onrender.com/menus/${selectedMenuId}/additem`,
        newItem,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
